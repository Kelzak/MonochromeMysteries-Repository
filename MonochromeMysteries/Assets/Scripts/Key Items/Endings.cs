...
public class Endings : MonoBehaviour
{
    ...
    public IEnumerator KnifeScript()
    {
        ...
        Dialogue.AddLine(Dialogue.Character.Pete, "There’s a lot of things that prohibit you from getting closure, and one of ‘ems your own emotions. I reckon you ain’t too happy about gettin’ whacked, huh? It just ain’t fair...and if you ask this old geezer, ain’t nothing wrong with a little vigilante justice.");
