...
public class Tutorial : MonoBehaviour
{
    ...
    private IEnumerator DialogueScript()
    {
        ...
        Dialogue.AddLine(Dialogue.Character.Pete, "There's also a notepad section of your scrapbook where you can record your thoughts and observations. You’ll definitely want to use that later as well.");
